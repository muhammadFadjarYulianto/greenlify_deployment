            ...
            <section className="w-full mt-[99px] h-auto flex flex-col items-center gap-[33px]">
                <div className="w-full flex flex-col items-center space-y-6 md:space-y-8">
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                        <Badge
                            className="h-6 bg-emerald-600 text-background text-sm sm:text-base font-semibold px-2 py-1 rounded-md shadow-md">
                            {article.author}
                        </Badge>
                        <Typography
                            variant="p-semibold"
                        ...
                        {article.content
                            ? article.content.split("\n").map((paragraph, index) => (
                                <Typography
                                    key={index}
                                    variant="p"
                                    className="text-justify text-slate-700 mt-4"
                                >
                                    {paragraph}
                                </Typography>
                            ))
